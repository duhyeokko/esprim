...
export const createPages = async () => {
  const agent = createAgent({
    token: `d67eea8605f9e9d5630e19ae5b33698848bb15fc11c97706c6f5f1a429cc253b332923dce4e860a02d52534cbe46505e926c558cb8ad6336e692ea901095dc905ee7519b7aebf56f77366c5d5f87`,
  })
  ...
  try {
    const result = await agent.getRecordValues({
      requests: [{ id: '2c4163b6-79eb-4a5a-b214-b47f1af39bb7', table: 'block' }],
    })
    console.log(result)
  } catch (e) {
    console.error(e)
